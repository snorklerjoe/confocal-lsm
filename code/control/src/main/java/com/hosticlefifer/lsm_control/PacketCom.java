...
public class PacketCom {
     ...
     */
    public final synchronized byte[] request(byte[] data) throws IOException {
    ...
    public final synchronized Response request(Command command) throws IOException {
        return Response.fromBytes(request(command.getBytes()));
    }

    public final synchronized ArrayList<Response> request(ArrayList<Command> commands) throws IOException {
